export const reportIndexFixture = {
  ...
  selectionLens: {
    ...
    championScore: 5,
    whyThisWins: 'The concept uses a rare mechanism that no adjacent report covers.',
    acceptedTradeoff: 'The initial market is narrower than a generic workflow platform.',
  },
  files: {
    idea: 'idea.yaml',
